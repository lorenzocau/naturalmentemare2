...
import sty from "./PlasmicSelect__OptionGroup.module.css"; // plasmic-import: _nlNlZMZJBL4/css
import SUPER__PlasmicSelect from "./PlasmicSelect"; // plasmic-import: USQM_YP1YWs1/render
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              <Select__Option
                className={classNames("__wab_instance", sty.option___7LIe1)}
              />

              <Select__Option
                className={classNames("__wab_instance", sty.option__zB7CI)}
              />
            </React.Fragment>
          ),
