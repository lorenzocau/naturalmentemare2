...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: 7kytgFV7tW4v/css
import SearchsvgIcon from "./icons/PlasmicIcon__Searchsvg"; // plasmic-import: HpD0948zI2rd/icon
    ...
    >
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <SearchsvgIcon
              className={classNames(projectcss.all, sty.svg__oOScH)}
              role={"img"}
            />
          ),
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <ChecksvgIcon
              className={classNames(projectcss.all, sty.svg__o1IsW)}
              role={"img"}
            />
          ),
